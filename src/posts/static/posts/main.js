...
const dropzone = document.getElementById('my-drop-zone')
...
// Django Using CSRF protection with AJAX
...
// function will run with button click
const getData = () => {
    $.ajax({
        type: 'GET',
        url: `/data/${visible}`,
...
closeBtns.forEach(btn => {
    btn.addEventListener('click', ()=>{
        if(myDropzone.getQueuedFile().length > 0) {
            postForm.reset()
